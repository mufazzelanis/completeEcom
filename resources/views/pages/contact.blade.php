    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-gray-50 rounded-2xl p-6 space-y-4">
                @if(setting('contact_email', '') || setting('support_email', '') || setting('company_email', ''))
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm">{{ setting('contact_email') ?: setting('support_email') ?: setting('company_email') }}</p>
                    </div>
                </div>
                @endif

                @if(setting('contact_phone', '') || setting('company_phone', ''))
                <div class="flex items-start gap-3">
                    <div class="w-9 h-9 bg-indigo-100 rounded-xl flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm">{{ setting('contact_phone') ?: setting('company_phone') }}</p>
                    </div>
                </div>
                @endif
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm">{{ setting('contact_hours') }}</p>
                    </div>
                </div>
                @endif

                @if(setting('contact_address', '') || setting('company_address', ''))
                <div class="flex items-start gap-3">
                    <div class="w-9 h-9 bg-indigo-100 rounded-xl flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm">{{ setting('contact_address') ?: setting('company_address') }}</p>
                    </div>
                </div>
                @endif
            </div>
