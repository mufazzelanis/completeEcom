...
<header class="bg-white dark:bg-gray-900 shadow-sm sticky top-0 z-50 transition-colors" x-data="{ mobileOpen: false }">
    <div class="max-w-[1200px] mx-auto px-4">
        <div class="flex items-center justify-between h-14 md:h-16 gap-4">
            ...
            <div class="flex items-center gap-1 md:gap-3">
                ...
                @else
                    <a href="{{ route('login') }}" class="hidden md:block text-gray-600 dark:text-gray-300 hover:text-orange-500 font-medium text-sm px-3 py-1.5 rounded hover:bg-gray-100 dark:hover:bg-gray-800 transition">Login</a>
    ...
    <div x-show="mobileOpen" x-cloak x-transition class="md:hidden bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-700 shadow-xl">
        <div class="p-4">
            ...
            @endauth
            <nav class="space-y-1">
                <a href="{{ route('home') }}" class="block px-3 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-orange-50 dark:hover:bg-gray-800 hover:text-orange-600 rounded-lg transition">Home</a>
                <a href="{{ route('shop.index') }}" class="block px-3 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-orange-50 dark:hover:bg-gray-800 hover:text-orange-600 rounded-lg transition">Shop All</a>
                @php
                ...
                @if($mobileCategories->count() > 0)
                    <div x-data="{ showCats: false }">
                        ...
                        <div x-show="showCats" x-cloak class="pl-4 space-y-1 mt-1">
                            ...
                            @endforeach
                            <a href="{{ route('shop.index') }}" class="block px-3 py-2 text-xs text-orange-500 font-medium hover:bg-orange-50 dark:hover:bg-gray-800 rounded-lg transition">View All Categories →</a>
                        </div>
                    </div>
                @endif
                @auth
                    <a href="{{ route('orders.index') }}" class="block px-3 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-orange-50 dark:hover:bg-gray-800 hover:text-orange-600 rounded-lg transition">My Orders</a>
                    <a href="{{ route('wishlist.index') }}" class="block px-3 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-orange-50 dark:hover:bg-gray-800 hover:text-orange-600 rounded-lg transition">Wishlist</a>
                    <a href="{{ route('account.dashboard') }}" class="block px-3 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-orange-50 dark:hover:bg-gray-800 hover:text-orange-600 rounded-lg transition">My Account</a>
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                ...
                @else
                    <a href="{{ route('login') }}" class="block px-3 py-2.5 text-sm text-orange-600 font-medium hover:bg-orange-50 dark:hover:bg-gray-800 rounded-lg transition">Login</a>
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-sm">
                    ...
                    <li><a href="{{ route('pages.show', 'return-policy') }}" class="hover:text-orange-400 transition">Return Policy</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-sm text-gray-400">
                    ...
                    <li class="flex items-center gap-2">
                        ...
                        <a href="mailto:{{ setting('support_email', setting('company_email')) }}" class="hover:text-orange-400 transition">{{ setting('support_email', setting('company_email')) }}</a>
                    </li>
                    @endif
                </ul>
            </div>
