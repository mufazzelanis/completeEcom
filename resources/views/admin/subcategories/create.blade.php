        ...
        <form action="{{ route('admin.subcategories.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-1">Recommended: square, e.g. 300×300px.</p>
                ...
                <div class="flex justify-end space-x-3 pt-4">
                    ...
                    <button type="submit" class="px-6 py-2.5 bg-indigo-600 text-white rounded-xl text-sm font-medium hover:bg-indigo-700 transition">Create Subcategory</button>
                </div>
            </div>
        </form>
    </div>
