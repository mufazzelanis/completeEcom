...
<div class="bg-white rounded-xl shadow-sm border p-6 space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
            ...
            <select name="currency_position" class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500">
        ...
        <div>
            ...
            <select name="decimal_places" class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500">
                @for($i=0; $i<=4; $i++)
        ...
        <div>
            ...
            <select name="thousand_separator" class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500">
        ...
        <div>
            ...
            <select name="decimal_separator" class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500">
    ...
    <div class="mt-2 p-3 bg-indigo-50 rounded-lg">
        <p class="text-sm text-indigo-700">Preview: <strong>{{ $preview }}</strong></p>
    </div>

    <div class="flex items-center gap-2 pt-2">
        <input type="hidden" name="multi_currency_enabled" value="0">
        <input type="checkbox" name="multi_currency_enabled" id="multi_curr" value="1" class="rounded text-indigo-600"
...
<div class="flex justify-end">
    <button type="submit" class="px-6 py-2 bg-indigo-600 text-white rounded-lg text-sm font-semibold hover:bg-indigo-700 transition">Save Currency</button>
</div>
</form>
@endsection
