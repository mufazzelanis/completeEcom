...
<div class="bg-white rounded-xl shadow-sm border p-6 space-y-4">
    ...
    <label class="flex items-center gap-2 cursor-pointer">
        ...
        <input type="checkbox" name="free_shipping_enabled" id="free_ship" value="1" class="rounded text-indigo-600"
...
<div class="bg-white rounded-xl shadow-sm border p-6 space-y-4">
    ...
    <label class="flex items-center gap-2 cursor-pointer">
        ...
        <input type="checkbox" name="flat_rate_enabled" id="flat_ship" value="1" class="rounded text-indigo-600"
...
<div class="flex justify-end">
    <button type="submit" class="px-6 py-2 bg-indigo-600 text-white rounded-lg text-sm font-semibold hover:bg-indigo-700 transition">Save Shipping</button>
</div>
</form>
@endsection
