...
<div class="bg-white rounded-xl shadow-sm border p-6 space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <select name="default_language" class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500">
        ...
        <div>
            ...
            <select name="timezone" class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500">
        ...
        <div>
            ...
            <select name="date_format" class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500">
        ...
        <div>
            ...
            <select name="time_format" class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500">
    ...
    <div class="flex items-center gap-2 pt-2">
        ...
        <input type="checkbox" name="multi_language_enabled" id="multi_lang" value="1" class="rounded text-indigo-600"
...
<div class="flex justify-end">
    <button type="submit" class="px-6 py-2 bg-indigo-600 text-white rounded-lg text-sm font-semibold hover:bg-indigo-700 transition">Save Localization</button>
</div>
</form>
@endsection
