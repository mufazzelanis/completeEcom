...
<div class="bg-white rounded-xl shadow-sm border p-6 space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <select name="mail_mailer" class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-orange-500">
        ...
        <div>
            ...
            <select name="mail_encryption" class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-orange-500">
...
<div class="bg-white rounded-xl shadow-sm border p-6">
    ...
    <form method="POST" action="{{ route('admin.settings.test-email') }}" class="flex gap-3">
        ...
        <input type="email" name="test_email" required placeholder="Send test to this email"
               class="flex-1 border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-orange-500">
