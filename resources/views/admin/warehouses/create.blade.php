...
<div class="max-w-2xl">
    ...
    <form action="{{ route('admin.warehouses.store') }}" method="POST">
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6 space-y-4">
            <h2 class="font-semibold text-gray-800 text-lg">New Warehouse</h2>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Code * <span class="text-gray-400 font-normal">(unique short ID)</span></label>
                    <input type="text" name="code" value="{{ old('code') }}" required maxlength="20" placeholder="e.g. WH-01, DHAKA"
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="address" rows="2"
                        class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('address') }}</textarea>
                </div>
                <div>
            ...
            <div class="flex gap-3 pt-2">
                <button type="submit" class="flex-1 bg-indigo-600 text-white py-2.5 rounded-xl text-sm font-semibold hover:bg-indigo-700 transition">Create Warehouse</button>
