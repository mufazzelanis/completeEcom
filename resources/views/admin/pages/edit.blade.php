        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div class="col-span-2 space-y-5">
                <div class="bg-white rounded-2xl shadow-sm p-6 space-y-5">
                    ...
                    <div>
                        ...
                        @include('partials.rich-editor', ['name' => 'content', 'value' => old('content', $page->content), 'id' => 'content', 'placeholder' => 'Write the page content…'])
                    </div>
                </div>
            ...
            <div class="space-y-5">
                ...
                <div class="bg-white rounded-2xl shadow-sm p-6">
                    ...
                    <p class="text-xs text-gray-400 mt-1">Recommended: 1600×640px — a wide banner shown across the top of the page.</p>
                </div>
            </div>
        </div>
    </form>
