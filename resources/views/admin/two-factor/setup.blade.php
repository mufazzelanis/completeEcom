...
<div class="max-w-xl">
    ...
    <p class="text-sm text-gray-500 mb-6">Your admin account requires two-factor authentication. We've sent a 6-digit code to <strong>{{ $email }}</strong> — enter it below to finish setup.</p>
