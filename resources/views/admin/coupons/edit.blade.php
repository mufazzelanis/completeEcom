        ...
        <form action="{{ route('admin.coupons.update', $coupon->id) }}" method="POST">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="code" value="{{ old('code', $coupon->code) }}" style="text-transform:uppercase"
                ...
                <div class="flex justify-end space-x-3 pt-4">
                    ...
                    <button type="submit" class="px-6 py-2.5 bg-indigo-600 text-white rounded-xl text-sm font-medium hover:bg-indigo-700 transition">Update Coupon</button>
                </div>
            </div>
        </form>
    </div>
