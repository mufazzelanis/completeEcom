        ...
        <div class="bg-white rounded-2xl shadow-sm p-6">
            <div class="flex items-center justify-between mb-4">
                <div class="w-12 h-12 rounded-xl flex items-center justify-center
                    {{ $stat['color'] === 'blue' ? 'bg-blue-100' : ($stat['color'] === 'green' ? 'bg-green-100' : ($stat['color'] === 'purple' ? 'bg-purple-100' : 'bg-yellow-100')) }}">
                    <svg class="w-6 h-6 {{ $stat['color'] === 'blue' ? 'text-blue-600' : ($stat['color'] === 'green' ? 'text-green-600' : ($stat['color'] === 'purple' ? 'text-purple-600' : 'text-yellow-600')) }}"
            ...
            @foreach($topProducts as $product)
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs text-gray-400">{{ $product->views }} views</p>
                    </div>
