            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="px-6 py-4 text-center">
                    <div class="flex items-center justify-center gap-3">
                        ...
                        <form action="{{ route('admin.landing-pages.destroy', $lp) }}" method="POST" onsubmit="return uiConfirm(event, 'Delete this landing page? Orders already placed through it are kept.')">
                            @csrf @method('DELETE')
