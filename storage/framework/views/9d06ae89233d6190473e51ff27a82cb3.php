    ...
    <div class="space-y-4">
        ...
        <div>
            ...
            <textarea name="meta_description" rows="2" maxlength="300"
                class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none"><?php echo e(old('meta_description', $seo?->meta_description ?? '')); ?></textarea>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Meta Keywords</label>
                <input type="text" name="meta_keywords" value="<?php echo e(old('meta_keywords', $seo?->meta_keywords ?? '')); ?>"
            ...
            <div>
                ...
                <input type="url" name="canonical_url" value="<?php echo e(old('canonical_url', $seo?->canonical_url ?? '')); ?>" placeholder="https://..."
                    class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
            </div>
        </div>
        <div>
            ...
            <div class="flex items-center gap-3 mb-2">
                <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($seo->og_image)); ?>" class="h-12 w-20 object-cover rounded-lg border">
...
<?php /**PATH C:\xampp\htdocs\completeEcom\resources\views/admin/categories/_seo_fields.blade.php ENDPATH**/ ?>