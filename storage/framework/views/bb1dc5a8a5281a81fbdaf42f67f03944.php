                ...
                <tr class="hover:bg-gray-50 transition <?php echo e($category->parent_id ? 'bg-gray-50/50' : ''); ?>">
                    <td class="px-6 py-4">
                        <div class="flex flex-col gap-1">
                            <form action="<?php echo e(route('admin.categories.move-up', $category)); ?>" method="POST">
                            ...
                            <form action="<?php echo e(route('admin.categories.move-down', $category)); ?>" method="POST">
                                <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\completeEcom\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>