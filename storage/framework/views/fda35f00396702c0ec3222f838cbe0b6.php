<?php $__env->startSection('settings-title', 'Social Media'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">
                <span class="inline-block w-2.5 h-2.5 rounded-full mr-1" style="background-color: <?php echo e($social['color']); ?>"></span>
                <?php echo e($social['label']); ?>

            </label>
            <input type="url" name="<?php echo e($key); ?>" value="<?php echo e(setting($key, '')); ?>"
                   class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-orange-500"
                   placeholder="<?php echo e($social['ph']); ?>">
        </div>
...
<?php echo $__env->make('admin.settings.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\completeEcom\resources\views/admin/settings/social.blade.php ENDPATH**/ ?>