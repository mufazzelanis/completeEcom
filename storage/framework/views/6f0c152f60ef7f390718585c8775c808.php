...
?>
<!DOCTYPE html>
<html lang="<?php echo e($htmlLang); ?>" dir="<?php echo e($htmlDir); ?>" class="scroll-smooth">
<head>
    <meta charset="UTF-8">
    ...
    <?php if($pageKeywords): ?><meta name="keywords" content="<?php echo e($pageKeywords); ?>"><?php endif; ?>
    ...
    <link href="https://fonts.googleapis.com/css2?family=<?php echo e(str_replace(' ', '+', $googleFontName)); ?>:wght@400;500;600;700;800&display=swap" rel="stylesheet">
    <?php endif; ?>
    ...
    <meta property="og:description" content="<?php echo e($pageOgDesc); ?>">
    <meta property="og:url" content="<?php echo e($pageCanonical); ?>">
    <?php if($pageOgImage): ?><meta property="og:image" content="<?php echo e($pageOgImage); ?>"><?php endif; ?>

    
    <meta name="twitter:card" content="<?php echo e($pageTwitterCard); ?>">
    <?php if($twitterSite): ?><meta name="twitter:site" content="<?php echo e('@' . ltrim($twitterSite, '@')); ?>"><?php endif; ?>
    <meta name="twitter:title" content="<?php echo e($pageTwitterTitle); ?>">
    <meta name="twitter:description" content="<?php echo e($pageTwitterDesc); ?>">
    <?php if($pageTwitterImage): ?><meta name="twitter:image" content="<?php echo e($pageTwitterImage); ?>"><?php endif; ?>
    ...
    <script>
        ...
        (function () {
            ...
            var adminDefault = <?php echo e(Js::from($darkModeDefault)); ?>; // admin's Theme & Design → Dark Mode Default
            var isDark;
            if (stored) {
                isDark = stored === 'dark';
    ...
    <?php endif; ?>
    <?php if(!$isSystemFont || $radiusScale || $shadowScale || $containerScale || $buttonRadiusValue): ?>
    
    <style>
        <?php if(!$isSystemFont): ?>
        .font-sans { font-family: <?php echo e($fontFamily); ?> !important; }
        <?php endif; ?>
        <?php if($radiusScale): ?>
        <?php $__currentLoopData = $radiusScale; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class => $px): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        .<?php echo e($class); ?> { border-radius: <?php echo e($px); ?> !important; }
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
        <?php if($shadowScale): ?>
        .shadow-sm { box-shadow: <?php echo e($shadowScale); ?> !important; }
        <?php endif; ?>
        <?php if($containerScale): ?>
        .max-w-\[1200px\] { max-width: <?php echo e($containerScale); ?> !important; }
        <?php endif; ?>
        <?php if($buttonRadiusValue): ?>
        
        <?php $__currentLoopData = ['orange', 'pink', 'red']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php $__currentLoopData = $buttonColorSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php $__currentLoopData = $buttonRadiusClasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $radiusClass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        .bg-<?php echo e($color); ?>-<?php echo e($step); ?>.<?php echo e($radiusClass); ?> { border-radius: <?php echo e($buttonRadiusValue); ?> !important; }
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
...
<div class="bg-gray-800 text-gray-300 text-xs hidden md:block">
    <div class="max-w-[1200px] mx-auto px-4 flex items-center justify-between h-8">
        <div class="flex items-center gap-4">
            <span><?php echo e($topbarText ?: t('header.welcome_default', 'Welcome to :site', ['site' => $siteName], 'header')); ?></span>
            <span class="text-gray-600">|</span>
            <a href="<?php echo e(route('vendor.apply')); ?>" class="hover:text-white transition"><?php echo e(t('header.sell_on', 'Sell on :site', ['site' => $siteName], 'header')); ?></a>
        </div>
        <div class="flex items-center gap-4">
            <?php if($topbarPhone): ?>
                <a href="tel:<?php echo e(preg_replace('/[^0-9+]/', '', $topbarPhone)); ?>" class="hover:text-white transition flex items-center gap-1.5">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                    <?php echo e($topbarPhone); ?>

                </a>
                <span class="text-gray-600">|</span>
            <?php endif; ?>
            <?php if($topbarEmail): ?>
                <a href="mailto:<?php echo e($topbarEmail); ?>" class="hover:text-white transition flex items-center gap-1.5">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                    <?php echo e($topbarEmail); ?>

                </a>
                <span class="text-gray-600">|</span>
            <?php endif; ?>
            <a href="<?php echo e(route('guest.order.track.form')); ?>" class="hover:text-white transition"><?php echo e(t('header.track_order', 'Track Order', [], 'header')); ?></a>
            <span class="text-gray-600">|</span>
            <a href="<?php echo e(route('faq')); ?>" class="hover:text-white transition"><?php echo e(t('header.help_center', 'Help Center', [], 'header')); ?></a>
        </div>
    </div>
</div>
<?php endif; ?>
...
<div style="background: <?php echo e($announcementBg); ?>; color: <?php echo e($announcementColor); ?>;" class="text-sm py-1.5 text-center font-medium px-4" x-data="{ show: true }" x-show="show">
    <?php echo $announcementText; ?>

    <button @click="show = false" class="ml-3 opacity-70 hover:opacity-100 text-lg leading-none" style="color: <?php echo e($announcementColor); ?>;">&times;</button>
</div>
<?php endif; ?>


<header class="bg-white dark:bg-gray-900 shadow-sm <?php echo e($stickyHeader ? 'sticky top-0' : ''); ?> z-50 transition-colors" x-data="{ mobileOpen: false }">
    <div class="max-w-[1200px] mx-auto px-4">
        <?php if($headerLayout === 'centered'): ?>
            
            <div class="flex flex-col items-center py-3 gap-2">
                <?php echo $__env->make('partials.storefront.header-logo', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <div class="flex items-center justify-between w-full gap-4">
                    <?php echo $__env->make('partials.storefront.header-search', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php echo $__env->make('partials.storefront.header-actions', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        <?php else: ?>
    ...
    <div class="bg-orange-500 hidden md:block border-t border-orange-400">
        <div class="max-w-[1200px] mx-auto px-4 flex items-center overflow-x-auto scrollbar-hide">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('shop.index')); ?>" class="inline-flex items-center text-sm text-white/80 whitespace-nowrap hover:text-white px-3 py-2.5 ml-auto font-medium transition"><?php echo e(t('header.all_products', 'All Products', [], 'header')); ?> →</a>
        </div>
    </div>
    <?php endif; ?>
                ...
                <?php if($mobileCategories->count() > 0): ?>
                    <div x-data="{ showCats: false }">
                        <button @click="showCats = !showCats" class="flex items-center justify-between w-full px-3 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-orange-50 dark:hover:bg-gray-800 hover:text-orange-600 rounded-lg transition">
                            <span><?php echo e(t('header.categories', 'Categories', [], 'header')); ?></span>
                        ...
                        <div x-show="showCats" x-cloak class="pl-4 space-y-1 mt-1">
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('shop.index')); ?>" class="block px-3 py-2 text-xs text-orange-500 font-medium hover:bg-orange-50 dark:hover:bg-gray-800 rounded-lg transition"><?php echo e(t('header.view_all_categories', 'View All Categories', [], 'header')); ?> →</a>
                        </div>
                    </div>
                <?php endif; ?>
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('orders.index')); ?>" class="block px-3 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-orange-50 dark:hover:bg-gray-800 hover:text-orange-600 rounded-lg transition"><?php echo e(t('header.my_orders', 'My Orders', [], 'header')); ?></a>
                    <a href="<?php echo e(route('wishlist.index')); ?>" class="block px-3 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-orange-50 dark:hover:bg-gray-800 hover:text-orange-600 rounded-lg transition"><?php echo e(t('header.wishlist', 'Wishlist', [], 'header')); ?></a>
                    <a href="<?php echo e(route('account.dashboard')); ?>" class="block px-3 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-orange-50 dark:hover:bg-gray-800 hover:text-orange-600 rounded-lg transition"><?php echo e(t('header.my_account', 'My Account', [], 'header')); ?></a>
                    <form method="POST" action="<?php echo e(route('logout')); ?>">
                        <?php echo csrf_field(); ?>
                        <button type="submit" class="block w-full text-left px-3 py-2.5 text-sm text-red-500 hover:bg-red-50 dark:hover:bg-gray-800 rounded-lg transition"><?php echo e(t('header.logout', 'Logout', [], 'header')); ?></button>
                    </form>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="block px-3 py-2.5 text-sm text-orange-600 font-medium hover:bg-orange-50 dark:hover:bg-gray-800 rounded-lg transition"><?php echo e(t('header.login', 'Login', [], 'header')); ?></a>
                    <a href="<?php echo e(route('register')); ?>" class="block px-3 py-2.5 text-sm text-white bg-orange-500 text-center font-medium rounded-lg hover:bg-orange-600 transition"><?php echo e(t('header.signup', 'Sign Up', [], 'header')); ?></a>
                <?php endif; ?>
            </nav>
        </div>
    </div>
    ...
    <div class="bg-gray-800 border-b border-gray-700">
        <div class="max-w-[1200px] mx-auto px-4 py-8">
            <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                <div>
                    <h3 class="text-white text-lg font-bold"><?php echo e(t('footer.newsletter_title', 'Subscribe to Our Newsletter', [], 'footer')); ?></h3>
                    <p class="text-gray-400 text-sm mt-1"><?php echo e(t('footer.newsletter_subtitle', 'Get updates on new arrivals, deals, and exclusive offers.', [], 'footer')); ?></p>
                </div>
                <div class="w-full md:w-auto">
                    <form action="<?php echo e(route('newsletter.subscribe')); ?>" method="POST" class="flex w-full md:w-auto">
                        <?php echo csrf_field(); ?>
                        <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="<?php echo e(t('footer.email_placeholder', 'Enter your email', [], 'footer')); ?>" required class="flex-1 md:w-72 px-4 py-2.5 rounded-l-lg bg-gray-700 text-white border border-gray-600 focus:outline-none focus:border-orange-500 text-sm placeholder-gray-500">
                        <button type="submit" class="bg-orange-500 text-white px-6 py-2.5 rounded-r-lg font-medium text-sm hover:bg-orange-600 transition whitespace-nowrap"><?php echo e(t('footer.subscribe', 'Subscribe', [], 'footer')); ?></button>
                    </form>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="max-w-[1200px] mx-auto px-4 py-10">
        <div class="grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            <div>
                <h4 class="text-white font-bold mb-4 text-sm"><?php echo e(setting('footer_col2_title') ?: t('footer.quick_links_default', 'Quick Links', [], 'footer')); ?></h4>
                <ul class="space-y-2.5 text-sm">
                    <li><a href="<?php echo e(route('home')); ?>" class="hover:text-orange-400 transition"><?php echo e(t('footer.home', 'Home', [], 'footer')); ?></a></li>
                    <li><a href="<?php echo e($shopUrl); ?>" class="hover:text-orange-400 transition"><?php echo e(t('footer.shop', 'Shop', [], 'footer')); ?></a></li>
                    <li><a href="<?php echo e($blogUrl); ?>" class="hover:text-orange-400 transition"><?php echo e(t('footer.blog', 'Blog', [], 'footer')); ?></a></li>
                    <?php if($aboutUrl): ?><li><a href="<?php echo e($aboutUrl); ?>" class="hover:text-orange-400 transition"><?php echo e(t('footer.about_us', 'About Us', [], 'footer')); ?></a></li><?php endif; ?>
                    <li><a href="<?php echo e(route('vendor.apply')); ?>" class="hover:text-orange-400 transition"><?php echo e(t('footer.sell_on', 'Sell on :site', ['site' => $siteName], 'footer')); ?></a></li>
                </ul>
            </div>

            
            <div>
                <h4 class="text-white font-bold mb-4 text-sm"><?php echo e(setting('footer_col3_title') ?: t('footer.customer_service_default', 'Customer Service', [], 'footer')); ?></h4>
                <ul class="space-y-2.5 text-sm">
                    <li><a href="<?php echo e($contactUrl); ?>" class="hover:text-orange-400 transition"><?php echo e(t('footer.contact_us', 'Contact Us', [], 'footer')); ?></a></li>
                    <li><a href="<?php echo e(route('faq')); ?>" class="hover:text-orange-400 transition"><?php echo e(t('footer.faq', 'FAQ', [], 'footer')); ?></a></li>
                    <li><a href="<?php echo e(route('guest.order.track.form')); ?>" class="hover:text-orange-400 transition"><?php echo e(t('footer.track_order', 'Track Order', [], 'footer')); ?></a></li>
                    <li><a href="<?php echo e(route('pages.show', 'return-policy')); ?>" class="hover:text-orange-400 transition"><?php echo e(t('footer.return_policy', 'Return Policy', [], 'footer')); ?></a></li>
                    <?php if($termsUrl): ?><li><a href="<?php echo e($termsUrl); ?>" class="hover:text-orange-400 transition"><?php echo e(t('footer.terms', 'Terms & Conditions', [], 'footer')); ?></a></li><?php endif; ?>
                    <?php if($privacyUrl): ?><li><a href="<?php echo e($privacyUrl); ?>" class="hover:text-orange-400 transition"><?php echo e(t('footer.privacy', 'Privacy Policy', [], 'footer')); ?></a></li><?php endif; ?>
                </ul>
            </div>

            
            <div>
                <h4 class="text-white font-bold mb-4 text-sm"><?php echo e(setting('footer_col4_title') ?: t('footer.contact_default', 'Contact', [], 'footer')); ?></h4>
                <ul class="space-y-2.5 text-sm text-gray-400">
                    ...
                    <?php endif; ?>
                    <?php $contactEmail = setting('support_email') ?: setting('company_email'); ?>
                    <?php if($contactEmail): ?>
                    <li class="flex items-center gap-2">
                        ...
                        <a href="mailto:<?php echo e($contactEmail); ?>" class="hover:text-orange-400 transition"><?php echo e($contactEmail); ?></a>
                    </li>
                    <?php endif; ?>
                </ul>

                <?php if($fbUrl || $igUrl || $ytUrl || $twUrl || $waUrl || $msgUrl || $tkUrl || $liUrl || $ptUrl): ?>
