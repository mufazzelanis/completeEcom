...
<div class="mt-6"
    x-data="{
        seoTab: 'basic',
        aiFeatures: <?php echo e(Js::from(old('ai_key_features', $seo?->ai_key_features ?? []))); ?>,
        aiBenefits: <?php echo e(Js::from(old('ai_benefits',     $seo?->ai_benefits     ?? []))); ?>,
        aiUseCases: <?php echo e(Js::from(old('ai_use_cases',    $seo?->ai_use_cases    ?? []))); ?>,
    ...
    <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
        ...
        <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-emerald-50 to-teal-50">
            ...
            <div class="flex items-center gap-2 text-sm">
                ...
                <span class="font-bold px-2 py-0.5 rounded-lg text-sm
                    <?php echo e($savedScore >= 70 ? 'bg-emerald-100 text-emerald-700' : ($savedScore >= 40 ? 'bg-amber-100 text-amber-700' : 'bg-red-100 text-red-600')); ?>">
                    <?php echo e($savedScore); ?>/100
                </span>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="flex border-b border-gray-100 overflow-x-auto bg-gray-50/50">
            ...
            <button type="button" @click="seoTab='<?php echo e($tab); ?>'"
                class="flex items-center gap-1.5 px-4 py-3 text-sm font-medium whitespace-nowrap border-b-2 transition-colors"
                :class="seoTab==='<?php echo e($tab); ?>' ? 'border-emerald-500 text-emerald-700 bg-white' : 'border-transparent text-gray-500 hover:text-gray-700'">
        ...
        <div class="p-6">
            ...
            <div x-show="seoTab==='basic'" x-cloak>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="meta_title" value="<?php echo e(old('meta_title', $seo?->meta_title ?? '')); ?>" maxlength="100"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="meta_description" rows="3" maxlength="300"
                            class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 resize-none"><?php echo e(old('meta_description', $seo?->meta_description ?? '')); ?></textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Focus Keyword</label>
                        <input type="text" name="focus_keyword" value="<?php echo e(old('focus_keyword', $seo?->focus_keyword ?? '')); ?>"
                    ...
                    <div>
                        ...
                        <input type="url" name="canonical_url" value="<?php echo e(old('canonical_url', $seo?->canonical_url ?? '')); ?>"
                            placeholder="https://..."
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                    </div>
                    <div>
                        ...
                        <select name="robots_meta"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                            <?php $__currentLoopData = ['index,follow' => 'Index, Follow (default)', 'noindex,follow' => 'No Index, Follow', 'index,nofollow' => 'Index, No Follow', 'noindex,nofollow' => 'No Index, No Follow']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($val); ?>" <?php echo e(old('robots_meta', $seo?->robots_meta ?? 'index,follow') === $val ? 'selected' : ''); ?>><?php echo e($lbl); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        ...
                        <input type="text" name="breadcrumb_title" value="<?php echo e(old('breadcrumb_title', $seo?->breadcrumb_title ?? '')); ?>"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                    </div>
                    <div>
                        ...
                        <select name="sitemap_priority"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                            <?php $__currentLoopData = ['1.00'=>'1.0 — Highest','0.80'=>'0.8 — High','0.60'=>'0.6 — Medium-High','0.50'=>'0.5 — Medium (default)','0.30'=>'0.3 — Low','0.10'=>'0.1 — Very Low']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($val); ?>" <?php echo e(number_format((float) old('sitemap_priority', $seo?->sitemap_priority ?? 0.5), 2) === $val ? 'selected' : ''); ?>><?php echo e($lbl); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="sitemap_changefreq"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                            <?php $__currentLoopData = ['always'=>'Always','hourly'=>'Hourly','daily'=>'Daily','weekly'=>'Weekly','monthly'=>'Monthly','yearly'=>'Yearly','never'=>'Never']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($val); ?>" <?php echo e(old('sitemap_changefreq', $seo?->sitemap_changefreq ?? 'weekly') === $val ? 'selected' : ''); ?>><?php echo e($lbl); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">301 Redirect URL</label>
                        <input type="url" name="redirect_url" value="<?php echo e(old('redirect_url', $seo?->redirect_url ?? '')); ?>"
            ...
            <div x-show="seoTab==='social'" x-cloak>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="og_title" value="<?php echo e(old('og_title', $seo?->og_title ?? '')); ?>" maxlength="100"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                    </div>
                    <div>
                        ...
                        <input type="url" name="og_image" value="<?php echo e(old('og_image', $seo?->og_image ?? '')); ?>"
                            placeholder="https://..."
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <textarea name="og_description" rows="2" maxlength="300"
                            class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 resize-none"><?php echo e(old('og_description', $seo?->og_description ?? '')); ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="twitter_card"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                            <?php $__currentLoopData = ['summary'=>'Summary (small image)','summary_large_image'=>'Summary with Large Image']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($val); ?>" <?php echo e(old('twitter_card', $seo?->twitter_card ?? 'summary_large_image') === $val ? 'selected' : ''); ?>><?php echo e($lbl); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        ...
                        <input type="text" name="twitter_title" value="<?php echo e(old('twitter_title', $seo?->twitter_title ?? '')); ?>" maxlength="70"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                    </div>
                    <div>
                        ...
                        <input type="url" name="twitter_image" value="<?php echo e(old('twitter_image', $seo?->twitter_image ?? '')); ?>"
                            placeholder="https://..."
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                    </div>
                    <div>
                        ...
                        <textarea name="twitter_description" rows="2" maxlength="200"
                            class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 resize-none"><?php echo e(old('twitter_description', $seo?->twitter_description ?? '')); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div x-show="seoTab==='visibility'" x-cloak>
                <div class="max-w-2xl space-y-4">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$fname, $flabel, $fdesc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-start gap-4 bg-gray-50 rounded-xl p-4">
                        <label class="relative inline-flex items-center cursor-pointer mt-0.5 flex-shrink-0">
                            <input type="checkbox" name="<?php echo e($fname); ?>" value="1"
                                <?php echo e(old($fname, $seo?->{$fname} ?? false) ? 'checked' : ''); ?>
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-800"><?php echo e($flabel); ?></p>
                            <p class="text-xs text-gray-500 mt-0.5"><?php echo e($fdesc); ?></p>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div>
                        ...
                        <select name="schema_type"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                            <?php $__currentLoopData = ['Product'=>'Product','ItemPage'=>'Item Page','SoftwareApplication'=>'Software','Book'=>'Book','MusicAlbum'=>'Music Album']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($val); ?>" <?php echo e(old('schema_type', $seo?->schema_type ?? 'Product') === $val ? 'selected' : ''); ?>><?php echo e($lbl); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="schema_condition"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                            <?php $__currentLoopData = ['NewCondition'=>'New','UsedCondition'=>'Used','RefurbishedCondition'=>'Refurbished','DamagedCondition'=>'Damaged']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($val); ?>" <?php echo e(old('schema_condition', $seo?->schema_condition ?? 'NewCondition') === $val ? 'selected' : ''); ?>><?php echo e($lbl); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="schema_availability"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                            <?php $__currentLoopData = ['InStock'=>'In Stock','OutOfStock'=>'Out of Stock','PreOrder'=>'Pre-order','BackOrder'=>'Back Order','Discontinued'=>'Discontinued','SoldOut'=>'Sold Out']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($val); ?>" <?php echo e(old('schema_availability', $seo?->schema_availability ?? 'InStock') === $val ? 'selected' : ''); ?>><?php echo e($lbl); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        ...
                        <input type="date" name="price_valid_until"
                            value="<?php echo e(old('price_valid_until', $pvd)); ?>"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                    </div>
                    <div>
                        ...
                        <input type="text" name="gtin" value="<?php echo e(old('gtin', $seo?->gtin ?? '')); ?>"
                    ...
                    <div>
                        ...
                        <input type="text" name="mpn" value="<?php echo e(old('mpn', $seo?->mpn ?? '')); ?>"
                            placeholder="e.g. WH-1000XM5"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                    </div>
                    <div class="md:col-span-3">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Country of Origin</label>
                        <input type="text" name="country_of_origin" value="<?php echo e(old('country_of_origin', $seo?->country_of_origin ?? '')); ?>"
            ...
            <div x-show="seoTab==='merchant'" x-cloak>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="google_category" value="<?php echo e(old('google_category', $seo?->google_category ?? '')); ?>"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="google_product_type" value="<?php echo e(old('google_product_type', $seo?->google_product_type ?? '')); ?>"
                    ...
                    <div>
                        ...
                        <select name="age_group"
                            ...
                            <?php $__currentLoopData = ['newborn'=>'Newborn','infant'=>'Infant','toddler'=>'Toddler','kids'=>'Kids','adult'=>'Adult']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($val); ?>" <?php echo e(old('age_group', $seo?->age_group ?? '') === $val ? 'selected' : ''); ?>><?php echo e($lbl); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="gender"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                            <option value="">— Not specified —</option>
                            <?php $__currentLoopData = ['male'=>'Male','female'=>'Female','unisex'=>'Unisex']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($val); ?>" <?php echo e(old('gender', $seo?->gender ?? '') === $val ? 'selected' : ''); ?>><?php echo e($lbl); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Color</label>
                        <input type="text" name="color_description" value="<?php echo e(old('color_description', $seo?->color_description ?? '')); ?>"
                            placeholder="e.g. Midnight Black"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Size</label>
                        <input type="text" name="size_description" value="<?php echo e(old('size_description', $seo?->size_description ?? '')); ?>"
                            placeholder="e.g. One Size / XL"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Material</label>
                        <input type="text" name="material" value="<?php echo e(old('material', $seo?->material ?? '')); ?>"
                    ...
                    <div>
                        ...
                        <input type="text" name="image_alt" value="<?php echo e(old('image_alt', $seo?->image_alt ?? '')); ?>"
                    ...
                    <div>
                        ...
                        <input type="text" name="image_title" value="<?php echo e(old('image_title', $seo?->image_title ?? '')); ?>"
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <textarea name="ai_summary" rows="3"
                            class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"><?php echo e(old('ai_summary', $seo?->ai_summary ?? '')); ?></textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <textarea name="ai_overview" rows="4"
                            class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"><?php echo e(old('ai_overview', $seo?->ai_overview ?? '')); ?></textarea>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="ai_comparison" rows="3"
                            class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"><?php echo e(old('ai_comparison', $seo?->ai_comparison ?? '')); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div x-show="seoTab==='audit'" x-cloak>
                <div class="space-y-5">
                    ...
                    <div class="flex items-center gap-5 bg-gray-50 rounded-xl p-5">
                        <div class="relative w-24 h-24 flex-shrink-0">
                            <svg class="w-24 h-24 -rotate-90" viewBox="0 0 36 36">
                                ...
                                <circle cx="18" cy="18" r="15.9155" fill="none"
                                    stroke="<?php echo e($savedScore >= 70 ? '#10b981' : ($savedScore >= 40 ? '#f59e0b' : '#ef4444')); ?>"
                                    stroke-width="3"
                                    stroke-dasharray="<?php echo e($savedScore); ?> <?php echo e(100 - $savedScore); ?>"
                                    stroke-linecap="round"/>
                            </svg>
                            <div class="absolute inset-0 flex items-center justify-center">
                                <span class="text-2xl font-bold <?php echo e($savedScore >= 70 ? 'text-emerald-600' : ($savedScore >= 40 ? 'text-amber-500' : 'text-red-500')); ?>">
                                    <?php echo e($savedScore); ?>
                        ...
                        <div>
                            <p class="text-lg font-semibold text-gray-800">
                                <?php if($savedScore >= 70): ?> Good — well optimized!
                                <?php elseif($savedScore >= 40): ?> Needs improvement
                                <?php else: ?> Poor — significant SEO issues found
                                <?php endif; ?>
                            </p>
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            <?php $__currentLoopData = $auditChecks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $check): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-start gap-3 rounded-xl px-4 py-3 <?php echo e($check['ok'] ? 'bg-emerald-50 border border-emerald-100' : 'bg-gray-50 border border-gray-100'); ?>">
                                <svg class="w-4 h-4 mt-0.5 flex-shrink-0 <?php echo e($check['ok'] ? 'text-emerald-500' : 'text-gray-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($check['ok'] ? 'M5 13l4 4L19 7' : 'M12 12m0 0'); ?>"/>
                                    <?php if(!$check['ok']): ?>
                                    <circle cx="12" cy="12" r="3" fill="currentColor"/>
                                    <?php endif; ?>
                                </svg>
                                <span class="text-sm <?php echo e($check['ok'] ? 'text-emerald-700' : 'text-gray-600'); ?>"><?php echo e($check['msg']); ?></span>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\completeEcom\resources\views/admin/products/_seo_fields.blade.php ENDPATH**/ ?>