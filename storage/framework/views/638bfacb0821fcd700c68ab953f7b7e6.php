...
<form method="POST" action="<?php echo e(route('admin.settings.update', 'shipping')); ?>"
      x-data="{ method: '<?php echo e(setting('shipping_method', 'zone')); ?>' }">
...
<div class="bg-white rounded-xl shadow-sm border p-6 space-y-4">
    ...
    <label class="flex items-center gap-2 cursor-pointer">
        ...
        <input type="checkbox" name="free_shipping_enabled" id="free_ship" value="1" class="rounded text-orange-600"
               <?php if(setting('free_shipping_enabled','0') == '1'): echo 'checked'; endif; ?>>
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input type="number" name="free_shipping_min" value="<?php echo e(setting('free_shipping_min', '999')); ?>"
                   min="0" step="1"
...
<div class="bg-white rounded-xl shadow-sm border p-6 space-y-4">
    ...
    <div x-show="method === 'zone'" x-cloak class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
        <div>
            ...
            <div class="relative">
                <span class="absolute left-3 top-2 text-gray-500 text-sm"><?php echo e(setting('currency_symbol','৳')); ?></span>
                <input type="number" name="dhaka_charge" value="<?php echo e(setting('dhaka_charge', '60')); ?>"
                       min="0" step="1"
                       class="w-full border rounded-lg pl-8 pr-3 py-2 text-sm focus:ring-2 focus:ring-orange-500">
            </div>
        </div>
        <div>
            ...
            <div class="relative">
                <span class="absolute left-3 top-2 text-gray-500 text-sm"><?php echo e(setting('currency_symbol','৳')); ?></span>
                <input type="number" name="outside_dhaka_charge" value="<?php echo e(setting('outside_dhaka_charge', '120')); ?>"
                       min="0" step="1"
                       class="w-full border rounded-lg pl-8 pr-3 py-2 text-sm focus:ring-2 focus:ring-orange-500">
            </div>
        </div>
    ...
    <div x-show="method === 'flat'" x-cloak class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
        <div>
            ...
            <div class="relative">
                <span class="absolute left-3 top-2 text-gray-500 text-sm"><?php echo e(setting('currency_symbol','৳')); ?></span>
                <input type="number" name="flat_rate_amount" value="<?php echo e(setting('flat_rate_amount', '60')); ?>"
                       min="0" step="1"
                       class="w-full border rounded-lg pl-8 pr-3 py-2 text-sm focus:ring-2 focus:ring-orange-500">
            </div>
        </div>
        <div>
            ...
            <input type="text" name="flat_rate_label" value="<?php echo e(setting('flat_rate_label', 'Standard Delivery')); ?>"
...
<div class="bg-white rounded-xl shadow-sm border p-6 space-y-4">
    ...
    <div class="grid grid-cols-1 gap-4">
        <div>
            ...
            <input type="text" name="delivery_days" value="<?php echo e(setting('delivery_days', '3-7')); ?>"
                   class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-orange-500"
                   placeholder="3-7">
        </div>
        <div>
            ...
            <textarea name="delivery_charge_rules" rows="3"
                      class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-orange-500"
                      placeholder="e.g. Cash on delivery available nationwide. Delivery within 3-7 business days."><?php echo e(setting('delivery_charge_rules', '')); ?></textarea>
        </div>
    </div>
</div>
...
<?php echo $__env->make('admin.settings.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\completeEcom\resources\views/admin/settings/shipping.blade.php ENDPATH**/ ?>