...
<div class="max-w-[1200px] mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
        ...
        <?php else: ?>
            <form action="<?php echo e(route('cart.coupon')); ?>" method="POST" class="flex space-x-2">
                <?php echo csrf_field(); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
        ...
        <p class="text-xs text-gray-400 mb-3">Balance: <span class="font-semibold text-gray-600"><?php echo e(number_format($pointsBalance)); ?> pts</span></p>
        <?php if($pointsRedeemed > 0): ?>
            <div class="flex items-center justify-between bg-green-50 border border-green-200 rounded-xl px-4 py-3">
                <div>
                    <p class="text-sm font-semibold text-green-700"><?php echo e(number_format($pointsRedeemed)); ?> pts applied</p>
                    <p class="text-xs text-green-500">-৳<?php echo e(number_format($pointsDiscount)); ?> discount</p>
                </div>
                <form action="<?php echo e(route('cart.points.remove')); ?>" method="POST">
                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                    <button type="submit" class="text-red-400 hover:text-red-600 text-xs">Remove</button>
                </form>
            </div>
        <?php elseif($pointsBalance > 0): ?>
            <form action="<?php echo e(route('cart.points')); ?>" method="POST" class="flex space-x-2">
                <?php echo csrf_field(); ?>
                <input type="number" name="points" min="1" max="<?php echo e($pointsBalance); ?>" placeholder="Points to use"
    ...
    <form action="<?php echo e(route('checkout.store')); ?>" method="POST"
        x-data="{
            ...
            shippingByZone: <?php echo e(Js::from($shippingByZone)); ?>,
            flatShipping: <?php echo e($usesZones ? 0 : $shipping); ?>,
            ...
            methodChargesByZone: <?php echo e(Js::from($usesZones ? [
            ...
            <div class="lg:col-span-3 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e($checkoutFields['name']['label']); ?> <span class="text-red-500">*</span></label>
                            <input type="text" name="shipping_name" id="shipping_name"
                                value="<?php echo e(old('shipping_name')); ?>" placeholder="<?php echo e($checkoutFields['name']['placeholder']); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e($checkoutFields['phone']['label']); ?> <span class="text-red-500">*</span></label>
                            <input type="text" name="shipping_phone" id="shipping_phone"
                                value="<?php echo e(old('shipping_phone')); ?>" placeholder="<?php echo e($checkoutFields['phone']['placeholder']); ?>"
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e($checkoutFields['name']['label']); ?> <span class="text-red-500">*</span></label>
                            <input type="text" name="shipping_name" id="shipping_name"
                                value="<?php echo e(old('shipping_name', auth()->user()->name)); ?>" placeholder="<?php echo e($checkoutFields['name']['placeholder']); ?>"
                                class="w-full border rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 <?php echo e($errors->has('shipping_name') ? 'border-red-400 bg-red-50' : 'border-gray-200'); ?>">
                            <?php $__errorArgs = ['shipping_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e($checkoutFields['phone']['label']); ?>

                                <?php if($checkoutFields['phone']['mode'] === 'required'): ?><span class="text-red-500">*</span><?php else: ?> <span class="text-gray-400">(optional)</span><?php endif; ?>
                            </label>
                            <input type="text" name="shipping_phone" id="shipping_phone"
                                value="<?php echo e(old('shipping_phone', auth()->user()->phone)); ?>"
                                placeholder="<?php echo e($checkoutFields['phone']['placeholder']); ?>"
                                <?php if($checkoutFields['phone']['mode'] === 'required'): ?> required <?php endif; ?>
                                class="w-full border rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 <?php echo e($errors->has('shipping_phone') ? 'border-red-400 bg-red-50' : 'border-gray-200'); ?>">
                            <?php $__errorArgs = ['shipping_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php endif; ?>
                        <?php if($checkoutFields['address']['mode'] !== 'hidden'): ?>
                        <div class="sm:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e($checkoutFields['address']['label']); ?>

                                <?php if($checkoutFields['address']['mode'] === 'required'): ?><span class="text-red-500">*</span><?php else: ?> <span class="text-gray-400">(optional)</span><?php endif; ?>
                            </label>
                            <input type="text" name="shipping_address" id="shipping_address"
                                value="<?php echo e(old('shipping_address')); ?>"
                                placeholder="<?php echo e($checkoutFields['address']['placeholder']); ?>"
                                <?php if($checkoutFields['address']['mode'] === 'required'): ?> required <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php endif; ?>
                        <?php if($checkoutFields['city']['mode'] !== 'hidden'): ?>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e($checkoutFields['city']['label']); ?>

                                <?php if($checkoutFields['city']['mode'] === 'required'): ?><span class="text-red-500">*</span><?php else: ?> <span class="text-gray-400">(optional)</span><?php endif; ?>
                            </label>
                            <input type="text" name="shipping_city" id="shipping_city"
                                value="<?php echo e(old('shipping_city')); ?>" placeholder="<?php echo e($checkoutFields['city']['placeholder']); ?>"
                                <?php if($checkoutFields['city']['mode'] === 'required'): ?> required <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php endif; ?>
                        <?php if($checkoutFields['email']['mode'] !== 'hidden'): ?>
                        <div class="sm:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e($checkoutFields['email']['label']); ?>

                                <?php if($checkoutFields['email']['mode'] === 'required'): ?><span class="text-red-500">*</span><?php else: ?> <span class="text-gray-400">(optional)</span><?php endif; ?>
                            </label>
                            <input type="email" name="shipping_email" id="shipping_email"
                                value="<?php echo e(old('shipping_email', auth()->user()->email ?? '')); ?>"
                                placeholder="<?php echo e($checkoutFields['email']['placeholder']); ?>"
                                <?php if($checkoutFields['email']['mode'] === 'required'): ?> required <?php endif; ?>
                                class="w-full border rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 <?php echo e($errors->has('shipping_email') ? 'border-red-400 bg-red-50' : 'border-gray-200'); ?>">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <label class="flex items-center justify-between gap-2 border rounded-lg px-4 py-2.5 cursor-pointer transition"
                                    ...
                                    <span class="flex items-center gap-2">
                                        <span class="text-xs text-gray-400">৳<?php echo e(number_format($shippingByZone['dhaka'])); ?></span>
                                ...
                                <label class="flex items-center justify-between gap-2 border rounded-lg px-4 py-2.5 cursor-pointer transition"
                                    ...
                                    <span class="flex items-center gap-2">
                                        <span class="text-xs text-gray-400">৳<?php echo e(number_format($shippingByZone['outside_dhaka'])); ?></span>
                                        <input type="radio" name="shipping_zone" value="outside_dhaka" x-model="zone" class="text-orange-500">
                                    </span>
                                </label>
                            </div>
                            <?php $__errorArgs = ['shipping_zone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-500 text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php endif; ?>
                        <?php if($checkoutFields['state']['mode'] !== 'hidden'): ?>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e($checkoutFields['state']['label']); ?>

                                <?php if($checkoutFields['state']['mode'] === 'required'): ?><span class="text-red-500">*</span><?php endif; ?>
                            </label>
                            <input type="text" name="shipping_state" id="shipping_state"
                                value="<?php echo e(old('shipping_state')); ?>" placeholder="<?php echo e($checkoutFields['state']['placeholder']); ?>"
                                <?php if($checkoutFields['state']['mode'] === 'required'): ?> required <?php endif; ?>
                                class="w-full border rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 <?php echo e($errors->has('shipping_state') ? 'border-red-400 bg-red-50' : 'border-gray-200'); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php endif; ?>
                        <?php if($checkoutFields['zip']['mode'] !== 'hidden'): ?>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e($checkoutFields['zip']['label']); ?>

                                <?php if($checkoutFields['zip']['mode'] === 'required'): ?><span class="text-red-500">*</span><?php endif; ?>
                            </label>
                            <input type="text" name="shipping_zip" id="shipping_zip"
                                value="<?php echo e(old('shipping_zip')); ?>" placeholder="<?php echo e($checkoutFields['zip']['placeholder']); ?>"
                                <?php if($checkoutFields['zip']['mode'] === 'required'): ?> required <?php endif; ?>
                                class="w-full border rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 <?php echo e($errors->has('shipping_zip') ? 'border-red-400 bg-red-50' : 'border-gray-200'); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php endif; ?>
                        <?php if($checkoutFields['country']['mode'] !== 'hidden'): ?>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e($checkoutFields['country']['label']); ?></label>
                    ...
                    <?php if($checkoutFields['notes']['mode'] !== 'hidden'): ?>
                    <div class="mt-4">
                        <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e($checkoutFields['notes']['label']); ?>

                            <?php if($checkoutFields['notes']['mode'] === 'required'): ?><span class="text-red-500">*</span><?php else: ?> <span class="text-gray-400">(optional)</span><?php endif; ?>
                        </label>
                        <textarea name="notes" rows="2" placeholder="<?php echo e($checkoutFields['notes']['placeholder']); ?>"
                            <?php if($checkoutFields['notes']['mode'] === 'required'): ?> required <?php endif; ?>
                            class="w-full border rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 <?php echo e($errors->has('notes') ? 'border-red-400 bg-red-50' : 'border-gray-200'); ?>"><?php echo e(old('notes')); ?></textarea>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-xl shadow-sm p-6 lg:sticky lg:top-24">
                    ...
                    <div class="border-t border-gray-100 pt-4 space-y-2 text-sm">
                        ...
                        <?php if(($discount - $pointsDiscount) > 0): ?>
                            <div class="flex justify-between text-green-600">
                                <span>Discount (<?php echo e($coupon ?? $promoCode); ?>)</span>
                                <span>-৳<?php echo e(number_format($discount - $pointsDiscount)); ?></span>
                            </div>
                        <?php endif; ?>
                        <?php if($pointsDiscount > 0): ?>
                            <div class="flex justify-between text-green-600">
                                <span>Points Discount</span>
                                <span>-৳<?php echo e(number_format($pointsDiscount)); ?></span>
                            </div>
                        <?php endif; ?>
                        <div class="flex justify-between text-gray-600">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\completeEcom\resources\views/checkout/index.blade.php ENDPATH**/ ?>