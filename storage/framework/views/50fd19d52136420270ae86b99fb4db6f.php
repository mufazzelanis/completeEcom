...
<div class="flex items-center justify-between mb-5">
    ...
    <div class="flex gap-2">
        ...
        <a href="<?php echo e(route('orders.index', $val !== 'all' ? ['status' => $val] : [])); ?>"
            class="px-3 py-1.5 rounded-xl text-xs font-semibold transition <?php echo e((request('status', 'all') === $val) ? 'bg-indigo-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-100'); ?>">
            <?php echo e($label); ?>
    ...
    <div class="bg-white rounded-2xl shadow-sm p-5 hover:shadow-md transition">
        <div class="flex flex-wrap items-center justify-between gap-4 mb-4">
            ...
            <div class="text-center">
                ...
                <p class="font-bold text-gray-900">৳<?php echo e(number_format($order->total)); ?></p>
            </div>
            <span class="px-3 py-1 rounded-full text-xs font-semibold <?php echo e($order->status_badge); ?> capitalize"><?php echo e($order->status); ?></span>
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('orders.show', $order)); ?>" class="bg-indigo-50 text-indigo-600 hover:bg-indigo-100 transition text-xs font-semibold px-3 py-1.5 rounded-xl">View Details</a>
