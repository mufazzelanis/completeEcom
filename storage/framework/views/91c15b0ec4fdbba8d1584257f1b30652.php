    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-5">
        <div>
            ...
            <div class="flex items-center gap-2">
                <input type="color" name="primary_color" value="<?php echo e(setting('primary_color', '#ea580c')); ?>"
                       class="h-9 w-16 rounded border cursor-pointer">
                <input type="text" value="<?php echo e(setting('primary_color', '#ea580c')); ?>" readonly
        ...
        <div>
            ...
            <div class="flex items-center gap-2">
                <input type="color" name="accent_color" value="<?php echo e(setting('accent_color', '#dc2626')); ?>"
                       class="h-9 w-16 rounded border cursor-pointer">
                <input type="text" value="<?php echo e(setting('accent_color', '#dc2626')); ?>" readonly
                       class="flex-1 border rounded px-2 py-1.5 text-xs text-gray-600 font-mono bg-gray-50">
            </div>
        </div>
        <div>
    ...
    <div class="border-t pt-4 mt-2">
        ...
        <div class="rounded-xl border p-4 bg-gray-50">
            <div class="flex items-center gap-3 mb-3">
                ...
                <?php endif; ?>
                <span class="font-bold text-lg" style="color: <?php echo e(setting('primary_color', '#ea580c')); ?>">
...
<?php echo $__env->make('admin.settings.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\completeEcom\resources\views/admin/settings/branding.blade.php ENDPATH**/ ?>