...
<div class="max-w-3xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="<?php echo e(route('admin.notifications.index')); ?>" class="text-sm text-indigo-600 hover:underline">&larr; Back</a>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border p-6 space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <?php $__currentLoopData = $channelStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-start gap-3 p-4 rounded-lg border <?php echo e($info['configured'] ? 'border-green-200 bg-green-50' : 'border-amber-200 bg-amber-50'); ?>">
                <div class="mt-0.5">
                ...
                <div>
                    <p class="text-sm font-medium text-gray-900"><?php echo e($name); ?></p>
                    <p class="text-xs text-gray-500 mt-0.5">Driver: <code class="bg-gray-100 px-1 rounded"><?php echo e($info['driver']); ?></code></p>
                    <p class="text-xs mt-0.5 <?php echo e($info['configured'] ? 'text-green-600' : 'text-amber-600'); ?>">
                        <?php echo e($info['configured'] ? 'Configured' : 'Missing credentials in .env'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\completeEcom\resources\views/admin/notifications/settings.blade.php ENDPATH**/ ?>