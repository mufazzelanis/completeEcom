...
<div class="mb-6">
    <h1 class="text-xl font-bold text-gray-800">Welcome back, <?php echo e(auth()->user()->name); ?> 👋</h1>
...
<div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
    ...
    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $value, $link, $color, $bg, $path]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <a href="<?php echo e($link); ?>" class="bg-white rounded-2xl shadow-sm p-5 hover:shadow-md transition group">
        <div class="flex items-start justify-between mb-3">
            <div class="w-10 h-10 <?php echo e($bg); ?> rounded-xl flex items-center justify-center">
                <svg class="w-5 h-5 <?php echo e($color); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($path); ?>"/></svg>
            </div>
        ...
        <p class="text-2xl font-bold text-gray-800"><?php echo e($value); ?></p>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
    ...
    <div class="lg:col-span-2 bg-white rounded-2xl shadow-sm overflow-hidden">
        <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
            ...
            <a href="<?php echo e(route('orders.index')); ?>" class="text-xs text-indigo-600 hover:text-indigo-700 font-medium">View all</a>
        </div>
        ...
        <div class="px-5 py-3.5 border-b border-gray-50 hover:bg-gray-50 transition flex items-center gap-4">
            <div class="flex items-center gap-2 overflow-x-auto flex-1 min-w-0">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <div class="min-w-0">
                    <p class="text-sm font-medium text-gray-800"><?php echo e($order->order_number); ?></p>
                    <p class="text-xs text-gray-400"><?php echo e($order->created_at->format('M d, Y')); ?> · <?php echo e($order->items->count()); ?> item(s)</p>
                </div>
            </div>
            <div class="flex items-center gap-3 flex-shrink-0">
                <span class="text-sm font-semibold text-gray-800">৳<?php echo e(number_format($order->total)); ?></span>
                <span class="text-xs px-2 py-0.5 rounded-full font-semibold <?php echo e($order->status_badge); ?> capitalize"><?php echo e($order->status); ?></span>
                <a href="<?php echo e(route('orders.show', $order)); ?>" class="text-xs text-indigo-600 hover:text-indigo-800">View</a>
            </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        <div class="px-5 py-12 text-center text-gray-400 text-sm">
            No orders yet. <a href="<?php echo e(route('shop.index')); ?>" class="text-indigo-600">Start shopping</a>
        </div>
        <?php endif; ?>
    </div>
    ...
    <div class="space-y-4">
        <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
            <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                ...
                <a href="<?php echo e(route('account.notifications')); ?>" class="text-xs text-indigo-600 hover:text-indigo-700 font-medium">View all</a>
            </div>
            <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="px-5 py-3 border-b border-gray-50 flex items-start gap-3 <?php echo e(!$notif->is_read ? 'bg-indigo-50/40' : ''); ?>">
                <div class="mt-0.5 flex-shrink-0"><?php echo $notif->icon; ?></div>
                <div class="flex-1 min-w-0">
                    <p class="text-xs font-medium text-gray-800"><?php echo e($notif->title); ?></p>
                    <p class="text-xs text-gray-500 mt-0.5 truncate"><?php echo e($notif->message); ?></p>
        ...
        <div class="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl p-5 text-white">
            ...
            <a href="<?php echo e(route('account.referral')); ?>" class="inline-block bg-white/20 hover:bg-white/30 text-white text-xs font-semibold px-3 py-1.5 rounded-lg transition">
...
<?php echo $__env->make('layouts.account', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\completeEcom\resources\views/account/dashboard.blade.php ENDPATH**/ ?>