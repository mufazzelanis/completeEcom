    ...
    <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 text-white flex flex-col flex-shrink-0 overflow-y-auto transform transition-transform duration-200 ease-in-out lg:translate-x-0 lg:static lg:z-auto"
        ...
        <div class="flex items-center justify-between px-6 py-5 border-b border-gray-700">
            <div class="flex items-center space-x-3">
                <?php $logoUrl = setting_file_url('site_logo'); ?>
                <?php if($logoUrl): ?>
                <img src="<?php echo e($logoUrl); ?>" alt="<?php echo e(setting('site_name','ShopVista')); ?>" class="h-8 max-w-[120px] object-contain">
                <?php else: ?>
                <div class="w-8 h-8 bg-orange-500 rounded-lg flex items-center justify-center flex-shrink-0">
                    <span class="text-white font-bold"><?php echo e(strtoupper(substr(setting('site_name','S'),0,1))); ?></span>
                </div>
                <?php endif; ?>
                <div>
                    <div class="text-white font-bold text-sm"><?php echo e(setting('site_name', 'ShopVista')); ?></div>
        ...
        <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>"
                class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                <span>Dashboard</span>
            </a>
            <a href="<?php echo e(route('admin.home-sections.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.home-sections.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
            ...
            <a href="<?php echo e(route('admin.subcategories.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.subcategories.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
            ...
            <a href="<?php echo e(route('admin.reviews.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.reviews.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
            ...
            <a href="<?php echo e(route('admin.sale-products.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.sale-products.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/></svg>
                <span>Sale Products</span>
            </a>
            <a href="<?php echo e(route('admin.products.bulk-upload')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.products.bulk-upload') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"/></svg>
                <span>Bulk Upload</span>
            </a>
            <a href="<?php echo e(route('admin.brands.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.brands.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
            ...
            <a href="<?php echo e(route('admin.attributes.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.attributes.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
            ...
            <a href="<?php echo e(route('admin.stock-management.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.stock-management.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                <span>Stock Management</span>
            </a>
            <a href="<?php echo e(route('admin.stock-adjustments.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.stock-adjustments.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
            ...
            <a href="<?php echo e(route('admin.low-stock.index')); ?>"
                ...
                <?php if($lowStockCount > 0): ?><span class="bg-red-500 text-white text-xs rounded-full px-1.5 py-0.5 font-semibold"><?php echo e($lowStockCount); ?></span><?php endif; ?>
            </a>
            <a href="<?php echo e(route('admin.warehouses.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.warehouses.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                <span>Warehouses</span>
            </a>
            <a href="<?php echo e(route('admin.warehouse-stock.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.warehouse-stock.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg>
                <span>Multi-Warehouse</span>
            </a>
            <a href="<?php echo e(route('admin.stock-transfers.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.stock-transfers.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/></svg>
                <span>Stock Transfers</span>
            </a>
            <a href="<?php echo e(route('admin.batches.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.batches.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                <span>Batch / Lot</span>
            </a>
            <a href="<?php echo e(route('admin.barcodes.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.barcodes.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z"/></svg>
                <span>Barcodes</span>
            </a>
            <a href="<?php echo e(route('admin.sku-management.index')); ?>"
            ...
            <a href="<?php echo e(route('admin.purchases.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.purchases.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
            ...
            <a href="<?php echo e(route('admin.orders.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.orders.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg>
                <span>Orders</span>
            </a>
            <a href="<?php echo e(route('admin.returns.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.returns.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6"/></svg>
                <span>Returns</span>
                <?php $pendingReturns = \App\Models\ProductReturn::where('status','pending')->count(); ?>
                <?php if($pendingReturns > 0): ?>
                <span class="ml-auto bg-orange-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center flex-shrink-0"><?php echo e($pendingReturns > 9 ? '9+' : $pendingReturns); ?></span>
                <?php endif; ?>
            </a>
            <a href="<?php echo e(route('admin.payments.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.payments.index') || request()->routeIs('admin.payments.show') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/></svg>
                <span>Payments</span>
            </a>
            <a href="<?php echo e(route('admin.payment-methods.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.payment-methods.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"/></svg>
                <span>Payment Methods</span>
            </a>
            <a href="<?php echo e(route('admin.coupons.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.coupons.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/></svg>
                <span>Coupons</span>
            </a>
            ...
            <a href="<?php echo e(route('admin.reports.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.reports.index') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                <span>Overview</span>
            </a>
            <a href="<?php echo e(route('admin.reports.sales')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.reports.sales') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg>
                <span>Sales Report</span>
            </a>
            <a href="<?php echo e(route('admin.reports.revenue')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.reports.revenue') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                <span>Revenue</span>
            </a>
            <a href="<?php echo e(route('admin.reports.products')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.reports.products') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>
                <span>Products</span>
            </a>
            <a href="<?php echo e(route('admin.reports.customers')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.reports.customers') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                <span>Customers</span>
            </a>
            <a href="<?php echo e(route('admin.reports.inventory')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.reports.inventory') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
            ...
            <a href="<?php echo e(route('admin.blog.posts.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.blog.posts.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/></svg>
                <span>Blog Posts</span>
            </a>
            <a href="<?php echo e(route('admin.blog.categories.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.blog.categories.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/></svg>
                <span>Blog Categories</span>
            </a>
            <a href="<?php echo e(route('admin.banners.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.banners.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                <span>Banners</span>
            </a>
            <a href="<?php echo e(route('admin.pages.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.pages.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                <span>Pages</span>
            </a>
            <a href="<?php echo e(route('admin.faqs.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.faqs.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
            ...
            <a href="<?php echo e(route('admin.marketing.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.marketing.index') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
            ...
            <a href="<?php echo e(route('admin.flash-sales.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.flash-sales.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                <span class="flex-1">Flash Sales</span>
                <?php $liveFlash = \App\Models\FlashSale::where('is_active',true)->where('starts_at','<=',now())->where('ends_at','>=',now())->count(); ?>
                <?php if($liveFlash > 0): ?><span class="w-2 h-2 bg-red-500 rounded-full animate-pulse"></span><?php endif; ?>
            </a>
            <a href="<?php echo e(route('admin.promo-codes.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.promo-codes.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z"/></svg>
                <span>Promo Codes</span>
            </a>
            <a href="<?php echo e(route('admin.bundles.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.bundles.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>
                <span>Bundles</span>
            </a>
            <a href="<?php echo e(route('admin.cross-sell.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.cross-sell.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/></svg>
                <span>Cross-Sell / Upsell</span>
            </a>
            <a href="<?php echo e(route('admin.referrals.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.referrals.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                <span class="flex-1">Referrals</span>
                <?php $pendingRef = \App\Models\ReferralReward::where('status','pending')->count(); ?>
                <?php if($pendingRef > 0): ?><span class="bg-orange-500 text-white text-xs rounded-full px-1.5 py-0.5 font-semibold"><?php echo e($pendingRef); ?></span><?php endif; ?>
            </a>
            <a href="<?php echo e(route('admin.email-campaigns.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.email-campaigns.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
            ...
            <a href="<?php echo e(route('admin.notifications.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.notifications.index') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
                <span>Overview</span>
            </a>
            <a href="<?php echo e(route('admin.notifications.templates')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.notifications.templates*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                <span>Templates</span>
            </a>
            <a href="<?php echo e(route('admin.notifications.logs')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.notifications.logs') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                <span>Delivery Logs</span>
            </a>
            <a href="<?php echo e(route('admin.notifications.settings')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.notifications.settings') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
            ...
            <a href="<?php echo e(route('admin.users.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.users.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
            ...
            <?php $fraudFlagged = \App\Models\Order::where('is_fraud_flagged', true)->count(); ?>
            <a href="<?php echo e(route('admin.orders.index', ['fraud' => 1])); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.orders.index') && request('fraud') ? 'bg-red-700 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
            ...
            <a href="<?php echo e(route('admin.two-factor.show')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.two-factor.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                <span>Two-Factor Auth</span>
            </a>
            <a href="<?php echo e(route('admin.settings.show', 'general')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.settings.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                <span>General Settings</span>
            </a>
            <a href="<?php echo e(route('admin.languages.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.languages.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129"/></svg>
                <span>Languages</span>
            </a>
            <a href="<?php echo e(route('admin.translations.index')); ?>"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.translations.*') ? 'bg-orange-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
        ...
        <div class="px-4 py-4 border-t border-gray-700">
            <a href="<?php echo e(route('home')); ?>" class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm text-gray-300 hover:bg-gray-800 transition">
    ...
    <div class="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <header class="bg-white dark:bg-gray-900 shadow-sm px-4 sm:px-6 py-3 flex items-center gap-3 flex-shrink-0 transition-colors">
            ...
            <div class="relative flex-1 max-w-sm hidden sm:block" x-data="{
                ...
                allPages: <?php echo e(Js::from($adminNavIndex)); ?>,
                open: false,
                loading: false,
                activeIndex: -1,
                requestSeq: 0,
