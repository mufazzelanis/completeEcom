<?php $__env->startSection('settings-title', 'Invoice Settings'); ?>

<?php $__env->startSection('settings-content'); ?>
<form method="POST" action="<?php echo e(route('admin.settings.update', 'invoice')); ?>" enctype="multipart/form-data"
      x-data="{
          accent: '<?php echo e(setting('invoice_accent_color', '#6366f1')); ?>',
          dark: '<?php echo e(setting('invoice_dark_color', '#111827')); ?>',
      }">
...
<div class="bg-white rounded-xl shadow-sm border p-6 space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <input type="text" name="invoice_prefix" value="<?php echo e(setting('invoice_prefix', 'INV-')); ?>"
        ...
        <div>
            ...
            <input type="number" name="invoice_start_number" value="<?php echo e(setting('invoice_start_number', '1000')); ?>"
                   min="1"
                   class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-orange-500">
        </div>
    </div>
    ...
    ?>
    <p class="text-xs text-gray-400">Invoice numbers are generated sequentially from the order id — e.g. your next few invoices will read <span class="font-mono text-gray-600"><?php echo e($previewPrefix); ?><?php echo e(str_pad($previewStart, 6, '0', STR_PAD_LEFT)); ?></span>, <span class="font-mono text-gray-600"><?php echo e($previewPrefix); ?><?php echo e(str_pad($previewStart + 1, 6, '0', STR_PAD_LEFT)); ?></span>, <span class="font-mono text-gray-600"><?php echo e($previewPrefix); ?><?php echo e(str_pad($previewStart + 2, 6, '0', STR_PAD_LEFT)); ?></span>…</p>
    <div>
        <label class="block text-sm font-medium text-gray-700 mb-1">Invoice Logo</label>
        <?php $logoUrl = setting_file_url('invoice_logo'); ?>
        <?php if($logoUrl): ?>
        <div class="flex items-center gap-3 mb-2">
            <img src="<?php echo e($logoUrl); ?>" alt="Invoice Logo" class="h-10 max-w-[120px] object-contain rounded border p-1 bg-gray-50">
...
<div class="bg-white rounded-xl shadow-sm border p-6 space-y-4">
    ...
    <div>
        ...
        <textarea name="invoice_footer_text" rows="3"
                  class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-orange-500"
                  placeholder="Thank you for your purchase!"><?php echo e(setting('invoice_footer_text', 'Thank you for your business!')); ?></textarea>
    </div>
    <div>
        ...
        <textarea name="invoice_terms" rows="4"
                  class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-orange-500"
                  placeholder="Return policy, warranty, etc."><?php echo e(setting('invoice_terms', '')); ?></textarea>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Payment Due (days)</label>
            <input type="number" name="invoice_due_days" value="<?php echo e(setting('invoice_due_days', '0')); ?>"
                   min="0"
                   class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-orange-500">
    ...
    <div class="border-t pt-4 mt-2">
        ...
        <div class="rounded-xl border p-4 bg-gray-50 space-y-3">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-sm font-bold" :style="`color: ${accent}`"><?php echo e(setting('company_name') ?: setting('site_name', 'ShopVista')); ?></div>
...
<?php echo $__env->make('admin.settings.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\completeEcom\resources\views/admin/settings/invoice.blade.php ENDPATH**/ ?>