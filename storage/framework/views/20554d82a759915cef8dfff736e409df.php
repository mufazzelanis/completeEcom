...
?>
<?php $__env->startSection('title', $shopSeoTitle); ?>
<?php if($shopSeoDesc): ?><?php $__env->startSection('meta_description', $shopSeoDesc); ?><?php endif; ?>
<?php if(isset($category) && $category->meta_keywords): ?><?php $__env->startSection('meta_keywords', $category->meta_keywords); ?><?php endif; ?>
<?php $__env->startSection('canonical', $shopCanonical); ?>
<?php if($shopSeoImage): ?><?php $__env->startSection('og_image', $shopSeoImage); ?><?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\completeEcom\resources\views/shop/index.blade.php ENDPATH**/ ?>