...
<div class="flex items-center gap-1 md:gap-3">
    ...
    <?php if($showLanguageSwitcher ?? false): ?>
    <div class="relative hidden md:block" x-data="{ open: false }">
        <button @click="open = !open" class="flex items-center gap-1.5 px-2 py-2 rounded-lg text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition text-sm">
            <span><?php echo e($currentLanguage->flag_emoji ?? '🌐'); ?></span>
            <span class="font-medium"><?php echo e($currentLanguage->code ?? ''); ?></span>
        ...
        <div x-show="open" @click.outside="open = false" x-cloak x-transition
            ...
            <?php $__currentLoopData = $activeLanguages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(request()->fullUrlWithQuery(['lang' => $lang->code])); ?>"
                   class="flex items-center gap-2 px-4 py-2 text-sm hover:bg-orange-50 dark:hover:bg-gray-700 transition <?php echo e(($currentLanguage->code ?? '') === $lang->code ? 'text-orange-600 font-semibold' : 'text-gray-700 dark:text-gray-200'); ?>">
                    <span><?php echo e($lang->flag_emoji); ?></span>
                    <span><?php echo e($lang->native_name); ?></span>
                </a>
    ...
    <a href="<?php echo e(route('cart.index')); ?>" class="relative p-2 text-gray-600 dark:text-gray-300 hover:text-orange-500 transition group">
        ...
        <span id="header-cart-count"
              class="absolute -top-0.5 -right-0.5 bg-red-500 text-white text-[10px] rounded-full min-w-[18px] h-[18px] flex items-center justify-center font-bold pulse-badge <?php echo e($cartCount > 0 ? '' : 'hidden'); ?>"><?php echo e($cartCount); ?></span>
    </a>
        ...
        <div class="relative hidden md:block" x-data="{ open: false }">
            ...
            <div x-show="open" @click.outside="open = false" x-cloak x-transition
                ...
                <a href="<?php echo e(route('account.dashboard')); ?>" class="flex items-center px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-orange-50 dark:hover:bg-gray-700 hover:text-orange-600 transition gap-3">
                    ...
                    <?php echo e(t('header.my_account', 'My Account', [], 'header')); ?>
                ...
                <a href="<?php echo e(route('orders.index')); ?>" class="flex items-center px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-orange-50 dark:hover:bg-gray-700 hover:text-orange-600 transition gap-3">
                    ...
                    <?php echo e(t('header.my_orders', 'My Orders', [], 'header')); ?>
                ...
                <a href="<?php echo e(route('wishlist.index')); ?>" class="flex items-center px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-orange-50 dark:hover:bg-gray-700 hover:text-orange-600 transition gap-3">
                    ...
                    <?php echo e(t('header.wishlist', 'Wishlist', [], 'header')); ?>
                ...
                <?php if(auth()->user()->isAdmin()): ?>
                    <div class="border-t border-gray-100 dark:border-gray-700 mt-1 pt-1">
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center px-4 py-2.5 text-sm text-orange-600 hover:bg-orange-50 dark:hover:bg-gray-700 font-medium gap-3">
                            ...
                            <?php echo e(t('header.admin_panel', 'Admin Panel', [], 'header')); ?>
                ...
                <div class="border-t border-gray-100 dark:border-gray-700 mt-1 pt-1">
                    <form method="POST" action="<?php echo e(route('logout')); ?>">
                        ...
                        <button type="submit" class="flex items-center w-full px-4 py-2.5 text-sm text-red-500 hover:bg-red-50 dark:hover:bg-gray-700 transition gap-3">
                            ...
                            <?php echo e(t('header.logout', 'Logout', [], 'header')); ?>
    ...
    <?php else: ?>
        <a href="<?php echo e(route('login')); ?>" class="hidden md:block text-gray-600 dark:text-gray-300 hover:text-orange-500 font-medium text-sm px-3 py-1.5 rounded hover:bg-gray-100 dark:hover:bg-gray-800 transition"><?php echo e(t('header.login', 'Login', [], 'header')); ?></a>
        <a href="<?php echo e(route('register')); ?>" class="hidden md:block bg-orange-500 text-white px-4 py-1.5 rounded text-sm font-medium hover:bg-orange-600 transition"><?php echo e(t('header.signup', 'Sign Up', [], 'header')); ?></a>
    <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\azad-ecom\resources\views/partials/storefront/header-actions.blade.php ENDPATH**/ ?>