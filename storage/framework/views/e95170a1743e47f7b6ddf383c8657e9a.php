                ...
                <div class="bg-white rounded-2xl shadow-sm p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="name" id="product-name-input" value="<?php echo e(old('name', $product->name)); ?>"
                                class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">SKU</label>
                            <div class="flex gap-2">
                                <input type="text" name="sku" id="product-sku-input" value="<?php echo e(old('sku', $product->sku)); ?>" placeholder="e.g. TSHIRT-BLU-001"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div x-data="{ val: <?php echo e(Js::from(old('short_description', $product->short_description ?? ''))); ?> }">
                        ...
                        <div>
                            ...
                            <?php echo $__env->make('admin.products._description_editor', ['name' => 'description', 'value' => old('description', $product->description ?? ''), 'id' => 'description'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <div class="bg-white rounded-2xl shadow-sm p-6">
                    ...
                    <div x-data="{
                        preview: <?php echo e(Js::from($product->image ? Storage::url($product->image) : null)); ?>,
                        onFiles(fileList) {
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-5" x-data="{
                        images: <?php echo e(Js::from($product->images->map(fn($i) => ['id' => $i->id, 'url' => \Illuminate\Support\Facades\Storage::url($i->image)])->values()->toArray())); ?>,
                        dragIndex: null,
                        toDelete: [],
                        onDrop(i) {
